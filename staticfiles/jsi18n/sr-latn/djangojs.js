...
'use strict';
{
  ...
  const newcatalog = {
    "%(cnt)d submission in %(year)d": [
      "%(cnt)d poslato re\u0161enje u %(year)d",
      "%(cnt)d poslata re\u0161enja u %(year)d",
      "%(cnt)d poslatih re\u0161enja u %(year)d"
    ],
    "%(cnt)d submission in the last year": [
      "%(cnt)d poslato re\u0161enje u proteklih godinu dana",
      "%(cnt)d poslata re\u0161enja u proteklih godinu dana",
      "%(cnt)d poslatih re\u0161enja u proteklih godinu dana"
    ],
    "%(cnt)d submission on %(date)s": [
      "%(cnt)d poslato re\u0161enje %(date)s",
      "%(cnt)d poslata re\u0161enja %(date)s",
      "%(cnt)d poslatih re\u0161enja %(date)s"
    ],
    "%(cnt)d total submission": [
      "%(cnt)d poslato re\u0161enje",
      "%(cnt)d poslata re\u0161enje",
      "%(cnt)d poslatih re\u0161enja "
    ],
    ...
    "%s selected option not visible": [
      "%s izabrana opcija nije vidljiva",
      "%s izabrane opcije nisu vidljive",
      "%s izabranih opcija nije vidljivo"
    ],
    "6 a.m.": "18\u010d",
    "6 p.m.": "18\u010d",
    "April": "April",
    ...
    "December": "Decembar",
    "Edit points vote (%s)": "Promeni glas za poene (%s)",
    "February": "Februar",
    "Filter": "Filter",
    "Hide": "Sakrij",
    "January": "Januar",
    ...
    "November": "Novembar",
    "Now": "Trenutno vreme",
    "Number of votes for this point value": "Broj glasova za ovaj broj poena",
    "October": "Oktobar",
    "Remove": "Ukloni",
    ...
    "Type into this box to filter down the list of selected %s.": "Unesite u ovo polje da biste filtrirali listu izabranih %s.",
    "Unable to cast vote: %s": "Neuspe\u0161no slanje glasa: %s",
    "Unable to delete vote: %s": "Neuspe\u0161no brisanje glasa: %s",
    "Vote on problem points": "Glasajte za poene zadatka",
    "Yesterday": "Ju\u010de",
